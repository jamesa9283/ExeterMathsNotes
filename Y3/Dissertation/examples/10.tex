...
In the following section we will firstly follow Chapter 10 of ~\cite{holm_schmah_stoica_2009}, from which I summarise then derive the left, right and left and right invariant Euler-Poincar\'e equations for Pseudo-Rigid bodies.\\ % Following, we will look at introducing potential energy into the Lagrangian following a 2010 paper from Toshihiro Iwai~\cite{Iwai_2010}.\\
...
\begin{nthm}[Noethers Theorem for left-invariant Psudo Rigid Bodies]
...
\end{nthm}
\begin{nthm}[Noethers Theorem for right-invariant Psudo Rigid Bodies]
...
\end{nthm}
\begin{nthm}[Noethers Theorem for left and right -invariant Psudo Rigid Bodies]
