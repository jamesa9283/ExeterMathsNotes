...
Let $V$ be an $n$-dimensional vector space with dual $V^*$ and pairing $\ip{\vec w}{\vec u}_V$ where $u \in V$ and $w \in V^*$. Let $\mathcal{M}(n,\,\R)$ be a vector space of $n \ti n$ matrices with dual $\mathcal{M}(n,\,\R)^*$ and pairing $\ip{B}{A}_{\mathcal{M}} := \Tr(B^\top A)$ where $A \in \mathcal{M}(n,\,\R)$ and mathcal{B \in \mathcal{M}(n,\,\R)}.

The diamond map is a representation of the transformation of the pairing on $V$ to the pairing on $\mathcal{M}(n,\,\R)$.
