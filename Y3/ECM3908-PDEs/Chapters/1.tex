...
\begin{wrapfigure}{r}{0.5\textwidth}
  \centering
  \resizebox{0.5\textwidth}{!}{\input{./figures/transport_cl.pdf_tex}}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \centering
  \resizebox{0.5\textwidth}{!}{\input{./figures/transport_decay.pdf_tex}}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \centering
  \resizebox{0.5\textwidth}{!}{\input{./figures/characteristic_curves.pdf_tex}}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \centering
  \resizebox{0.5\textwidth}{!}{\input{./figures/geometry_QLPDE.pdf_tex}}
